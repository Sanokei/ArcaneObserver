/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2083c19c0e3d901d95a0d83c0f02c324)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEWS_SOURCE_URL" | "AI_MODEL" | "UPDATE_SECRET">> {}
}
declare module "*.html" {
	const value: string;
